...
from facelibuz.utils.misc import get_centroid
from facelibuz.utils.track import Track
...
class Tracker:
    ...
    def _update_track(self, track_id, frame_id, bbox, detection_confidence, class_id, lost, iou_score=0., **kwargs):
        """
        Update track state.
